...
## sdformat_vendor (kilted) - 0.2.8-1

The packages in the `sdformat_vendor` repository were released into the `kilted` distro by running `/Users/addisuzt/ws/.venv/bin/bloom-release --rosdistro kilted sdformat_vendor -y` on `Tue, 01 Sep 2026 02:55:26 -0000`
...
## sdformat_vendor (rolling) - 0.4.2-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/Users/addisuzt/ws/.venv/bin/bloom-release --rosdistro rolling sdformat_vendor -y` on `Wed, 26 Aug 2026 00:24:53 -0000`
...
## sdformat_vendor (lyrical) - 0.3.4-1

The packages in the `sdformat_vendor` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical sdformat_vendor` on `Thu, 16 Jul 2026 16:38:35 -0000`
...
## sdformat_vendor (rolling) - 0.4.1-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Thu, 16 Jul 2026 16:31:59 -0000`
...
## sdformat_vendor (rolling) - 0.4.0-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Thu, 14 May 2026 02:18:01 -0000`
...
## sdformat_vendor (kilted) - 0.2.7-1

The packages in the `sdformat_vendor` repository were released into the `kilted` distro by running `/Users/addisuzt/ws/gz_vendor_pkgs/vendor_pkgs/.venv/bin/bloom-release --rosdistro kilted sdformat_vendor -y` on `Thu, 12 Feb 2026 22:24:06 -0000`
...
## sdformat_vendor (jazzy) - 0.0.11-1

The packages in the `sdformat_vendor` repository were released into the `jazzy` distro by running `/Users/addisuzt/ws/gz_vendor_pkgs/vendor_pkgs/.venv/bin/bloom-release --rosdistro jazzy sdformat_vendor` on `Thu, 12 Feb 2026 22:21:20 -0000`
...
## sdformat_vendor (rolling) - 0.3.3-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Wed, 21 Jan 2026 17:53:21 -0000`
...
## sdformat_vendor (rolling) - 0.3.2-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Mon, 27 Oct 2025 23:16:08 -0000`
...
## sdformat_vendor (rolling) - 0.3.1-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Thu, 25 Sep 2025 04:50:49 -0000`
...
## sdformat_vendor (rolling) - 0.3.0-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Mon, 08 Sep 2025 23:24:37 -0000`
...
## sdformat_vendor (rolling) - 0.2.5-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling sdformat_vendor` on `Fri, 23 May 2025 09:59:13 -0000`
...
## sdformat_vendor (rolling) - 0.2.4-1

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Wed, 19 Feb 2025 21:54:02 -0000`
...
## sdformat_vendor (jazzy) - 0.0.9-1

The packages in the `sdformat_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy sdformat_vendor` on `Fri, 07 Feb 2025 15:57:43 -0000`
...
## sdformat_vendor (rolling) - 0.2.3-2

The packages in the `sdformat_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling sdformat_vendor` on `Tue, 26 Nov 2024 19:17:10 -0000`
...
## sdformat_vendor (rolling) - 0.2.3-1
